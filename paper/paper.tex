...
\def \BigAdd {\infer [A-Add] {(S,e) \Downarrow_A n \\ (S,e') \Downarrow_A n' } {(S,e+e') \Downarrow_A n+n'}}

\def \BigB {\infer [B-Bool] { } {(S,b) \Downarrow_B b}}

\def \BigNot {\infer [B-Not] {(S,e) \Downarrow_B b} {(S,\text{not}\ e) \Downarrow_B \neg b}}

\def \BigAnd {\infer [B-And] {(S,e) \Downarrow_B b \\ (S,e') \Downarrow_B b'} {(S,e\ \text{and}\ e') \Downarrow_B b \wedge b'}}

\def \BigLess {\infer [B-Less] {(S,e) \Downarrow_A n \\ (S,e') \Downarrow_A n'} {(S,e<e') \Downarrow_B n<n'}}
...
\def \nothing {\bullet}
\def \BigErr {\infer [S-Err] { } {(\mathit{err}\ n,S,s) \Downarrow_S (\mathit{err}\ n,S)}}
\def \BigSkip {\infer [S-Skip] { } {(E,S,\text{skip}) \Downarrow_S (E,S)}}
\def \BigAssn {\infer [S-Assn] {(S,e) \Downarrow_A n} {(\nothing,S,x \coloneqq e) \Downarrow_S (\nothing,S[x \rightarrow n])}}
\def \BigSeq {\infer [S-Seq] {(E,S,s) \Downarrow_S (E',S') \\ (E',S',s') \Downarrow_S (E'',S'')} {(E,S,s\ \text{seq}\ s') \Downarrow_S (E'',S'')}}
\def \BigIfT {\infer [S-IfT] {(S,e) \Downarrow_B \mathit{true} \\ (\nothing,S,s) \Downarrow_S (E,S')} {(\nothing,S,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_S (E,S')}}
\def \BigIfF {\infer [S-IfF] {(S,e) \Downarrow_B \mathit{false} \\ (\nothing,S,s') \Downarrow_S (E,S')} {(\nothing,S,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_S (E,S')}}
\def \BigWhileT {\infer [S-WhileT] {(S,e) \Downarrow_B \mathit{true} \\ (\nothing,S,s) \Downarrow_S (E,S') \\ (E,S',\text{while}\ e\ \text{do}\ s) \Downarrow_S (E',S'')} {(\nothing,S,\text{while}\ e\ \text{do}\ s) \Downarrow_S (E',S'')}}
\def \BigWhileF {\infer [S-WhileF] {(S,e) \Downarrow_B \mathit{false}} {(E,S,\text{while}\ e\ \text{do}\ s) \Downarrow_S (E,S)}}
\def \BigThrow {\infer [S-Throw] {(S,e) \Downarrow_A n} {(\nothing,S,\text{throw}\ e) \Downarrow_S (\mathit{err}\ n,S)}}
\def \BigTry {\infer [S-Try] {(\nothing,S,s) \Downarrow_S (\nothing,S')} {(\nothing,S,\text{try}\ s\ \text{catch}\ x\ \text{in}\ s') \Downarrow_S (\nothing,S')}}
\def \BigCatch {\infer [S-Catch] {(\nothing,S,s) \Downarrow_S (\mathit{err}\ n,S') \\ (\nothing,S'[x \rightarrow n],s') \Downarrow_S (E,S'')} {(\nothing,S,\text{try}\ s\ \text{catch}\ x\ \text{in}\ s') \Downarrow_S (E,S''[x \rightarrow S'(x)])}}
...
\def \BigVAdd {\infer [VA-Add] {(C,S,e) \Downarrow_{VA} v \\ (C,S,e') \Downarrow_{VA} v'} {(C,S,e+e') \Downarrow_{VA} \mathit{liftV2}(+,v,v')}}
\def \BigVAChcOne {\infer [VA-Chc1] {\mathit{sat}(C \wedge A) \\ \mathit{sat}(C \wedge \neg A) \\ (C \wedge A,S,e) \Downarrow_{VA} v \\ (C \wedge \neg A,S,e') \Downarrow_{VA} v'} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VA} \tagtree{A}{v}{v'}}}
\def \BigVAChcTwo {\infer [VA-Chc2] {\mathit{unsat}(C \wedge A) \\ \mathit{sat}(C \wedge \neg A) \\ (C \wedge \neg A,S,e') \Downarrow_{VA} v'} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VA} \tagtree{A}{\nothing}{v'}}}
\def \BigVAChcThree {\infer [VA-Chc3] {\mathit{sat}(C \wedge A) \\ \mathit{unsat}(C \wedge \neg A) \\ (C \wedge A,S,e) \Downarrow_{VA} v} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VA} \tagtree{A}{v}{\nothing}}}
\def \BigVAChcFour {\infer [VA-Chc4] {\mathit{unsat}(C \wedge A) \\ \mathit{unsat}(C \wedge \neg A)} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VA} \nothing}}

\def \BigVB {\infer [VB-Bool] { } {(C,S,b) \Downarrow_{VB} b}}
\def \BigVNot {\infer [VB-Not] {(C,S,e) \Downarrow_{VB} v} {(C,S,\text{not}\ e) \Downarrow_{VB} \mathit{liftV}(\neg,v)}}
\def \BigVAnd {\infer [VB-And] {(C,S,e) \Downarrow_{VB} v \\ (C,S,e') \Downarrow_{VB} v'} {(C,S,e\ \text{and}\ e') \Downarrow_{VB} \mathit{liftV2}(\wedge,v,v')}}
\def \BigVLess {\infer [VB-Less] {(C,S,e) \Downarrow_{VA} v \\ (C,S,e') \Downarrow_{VA} v'} {(C,S,e<e') \Downarrow_{VB} \mathit{liftV2}(<,v,v')}}
\def \BigVBChcOne {\infer [VB-Chc1] {\mathit{sat}(C \wedge A) \\ \mathit{sat}(C \wedge \neg A) \\ (C \wedge A,S,e) \Downarrow_{VB} v \\ (C \wedge \neg A,S,e') \Downarrow_{VB} v'} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VB} \tagtree{A}{v}{v'}}}
\def \BigVBChcTwo {\infer [VB-Chc2] {\mathit{unsat}(C \wedge A) \\ \mathit{sat}(C \wedge \neg A) \\ (C \wedge \neg A,S,e') \Downarrow_{VB} v'} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VB} \tagtree{A}{\nothing}{v'}}}
\def \BigVBChcThree {\infer [VB-Chc3] {\mathit{sat}(C \wedge A) \\ \mathit{unsat}(C \wedge \neg A) \\ (C \wedge A,S,e) \Downarrow_{VB} v} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VB} \tagtree{A}{v}{\nothing}}}
\def \BigVBChcFour {\infer [VB-Chc4] {\mathit{unsat}(C \wedge A) \\ \mathit{unsat}(C \wedge \neg A)} {(C,S,\tagtree{A}{e}{e'}) \Downarrow_{VB} \nothing}}
...
\def \T {\mathit{true}}
\def \F {\mathit{false}}
\def \BigVErr {\infer [VS-Err] { } {(C,S,E,\T,s) \Downarrow_{VS} (S,E,\T)}}
\def \BigVSkip {\infer [VS-Skip] { } {(C,S,E,F,\text{skip}) \Downarrow_{VS} (S,E,F)}}
\def \BigVAssn {\infer [VS-Assn] {(\GetCtx{C}{E},S,e) \Downarrow_{VA} v} {(C,S,E,\F,x \coloneqq e) \Downarrow_{VS} (S[(\GetCtx{C}{E},x) \rightarrow v],E,\F)}}
\def \BigVSeq {\infer [VS-Seq] {(C,S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ (C,S',E',F,s') \Downarrow_{VS} (S'',E'',F')} {(C,S,E,s\ \text{seq}\ s') \Downarrow_{VS} (S'',E'',F')}}
\def \BigVIfOne {\infer [VS-If1] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{sat}(\GetCtx{C \wedge \mathit{whenTrue}(v)}{E}) \\ (C \wedge \mathit{whenTrue}(v),S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ \mathit{sat}(\GetCtx{C \wedge \mathit{whenFalse}(v)}{E'}) \\ (C \wedge \mathit{whenFalse}(v),S',E',\F) \Downarrow_{VS} (S'',E'',F')} {(C,S,E,\F,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_{VS} (S'',E'',F \wedge F')}}
\def \BigVIfTwo {\infer [VS-If2] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{unsat}(\GetCtx{C \wedge \mathit{whenTrue}(v)}{E}) \\ \mathit{sat}(\GetCtx{C \wedge \mathit{whenFalse}(v)}{E}) \\ (C \wedge \mathit{whenFalse}(v),S,E,\F) \Downarrow_{VS} (S',E',F)} {(C,S,E,\F,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_{VS} (S',E',F)}}
\def \BigVIfThree {\infer [VS-If3] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{sat}(\GetCtx{C \wedge \mathit{whenTrue}(v)}{E}) \\ (C \wedge \mathit{whenTrue}(v),S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ \mathit{unsat}(\GetCtx{C \wedge \mathit{whenFalse}(v)}{E'})} {(C,S,E,\F,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_{VS} (S',E',F)}}
\def \BigVIfFour {\infer [VS-If4] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{unsat}(\GetCtx{C \wedge \mathit{whenTrue}(v)}{E}) \\ \mathit{unsat}(\GetCtx{C \wedge \mathit{whenFalse}(v)}{E'})} {(C,S,E,\F,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_{VS} (S,E,\F)}}
\def \BigVWhileT {\infer [VS-WhileT] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{sat}(\GetCtx{C \wedge \mathit{whenTrue}(v)}{E}) \\ (C \wedge \mathit{whenTrue}(v),S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ (C \wedge \mathit{whenTrue}(v),S',E',F,\text{while}\ e\ \text{do}\ s) \Downarrow_{VS} (S'',E'',F')} {(C,S,E,\F,\text{while}\ e\ \text{do}\ s) \Downarrow_{VS} (S'',E'',F')}}
...
\def \BigVThrow {\infer [VS-Throw] {(\GetCtx{C}{h:t},S,e) \Downarrow_{VA} v} {(C,S,h:t,\F,\text{throw}\ e) \Downarrow_{VS} (S,((C,v):h):t,\T)}}
\def \BigVTry {\infer [VS-Try] {(C,S,[]:E,\F,s) \Downarrow_{VS} (S',[]:E,\F)} {(C,S,E,\F,\text{try}\ s\ \text{catch}\ x\ \text{in}\ s') \Downarrow_{VS} (S',E,\F)}}
\def \BigVCatch {\infer [VS-Catch] {(C,S,[]:E,\F,s) \Downarrow_{VS} (S',(h:t):E,F) \\ (C \wedge \mathit{catchCtx}(h:t),S'[(\GetCtx{C}{E},x) \rightarrow \mathit{combine}(h:t)],E,\F,s']) \Downarrow_{VS} (S'',E',F')} {(C,S,E,\F,\text{try}\ s\ \text{catch}\ x\ \text{in}\ s') \Downarrow_{VS} (S''[(\T,x) \rightarrow S'(\T,x)],E',F')}}
\def \BigVChcOne {\infer [VS-Chc1] {\mathit{sat}(\GetCtx{C}{E} \wedge A) \\ \mathit{sat}(\GetCtx{C}{E} \wedge \neg A) \\ (C \wedge A,S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ (C \wedge \neg A,S',E',\F,s') \Downarrow_{VS} (S'',E'',F')} {(C,S,E,\F,\tagtree{A}{s}{s'}) \Downarrow_{VS} (S'',E'',F \wedge F')}}
\def \BigVChcTwo {\infer [VS-Chc2] {\mathit{unsat}(\GetCtx{C}{E} \wedge A) \\ \mathit{sat}(\GetCtx{C}{E} \wedge \neg A) \\ (C \wedge \neg A,S,E,\F,s') \Downarrow_{VS} (S',E',F)} {(C,S,E,\F,\tagtree{A}{s}{s'}) \Downarrow_{VS} (S',E',F)}}
\def \BigVChcThree {\infer [VS-Chc3] {\mathit{sat}(\GetCtx{C}{E} \wedge A) \\ \mathit{unsat}(\GetCtx{C}{E} \wedge \neg A) \\ (C \wedge A,S,E,\F,s) \Downarrow_{VS} (S',E',F)} {(C,S,E,\F,\tagtree{A}{s}{s'}) \Downarrow_{VS} (S',E',F)}}
\def \BigVChcFour {\infer [VS-Chc4] {\mathit{unsat}(\GetCtx{C}{E} \wedge A) \\ \mathit{unsat}(\GetCtx{C}{E} \wedge \neg A)} {(C,S,E,\F,\tagtree{A}{s}{s'}) \Downarrow_{VS} (S,E,\T)}}
