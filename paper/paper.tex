...
\def \BigVIfOne {\infer [VS-If1] {(\GetCtx{C}{E},S,e) \Downarrow_{VB} v \\ \mathit{sat}(C \wedge \mathit{whenTrue}(v)) \\ (C \wedge \mathit{whenTrue}(v),S,E,\F,s) \Downarrow_{VS} (S',E',F) \\ \mathit{sat}(C \wedge \mathit{whenFalse}(v)) \\ (C \wedge \mathit{whenFalse}(v),S',E',\F) \Downarrow_{VS} (S'',E'',F')} {(C,S,E,\F,\text{if}\ e\ \text{then}\ s\ \text{else}\ s') \Downarrow_{VS} (S'',E'',F \wedge F')}}
